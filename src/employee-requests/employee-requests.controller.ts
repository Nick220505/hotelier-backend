...
@ApiTags('permissions') // Using 'permissions' tag to match frontend expectations
@Controller('permissions') // This will handle /permissions routes
...
export class EmployeeRequestsController {
  ...
  findOne(@Param('id', ParseIntPipe) id: number): Promise<EmployeeRequest> {
  ...
  findByType(@Param('type') type: RequestType): Promise<EmployeeRequest[]> {
  ...
  reject(@Param('id', ParseIntPipe) id: number): Promise<EmployeeRequest> {
  ...
  remove(@Param('id', ParseIntPipe) id: number): Promise<EmployeeRequest> {
