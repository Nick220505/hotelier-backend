...
export class AttendanceController {
  ...
  findOne(@Param('id', ParseIntPipe) id: number): Promise<Attendance | null> {
  ...
  findByDate(@Param('date') date: string): Promise<Attendance[]> {
  ...
  create(@Body() data: CreateAttendanceDto): Promise<Attendance> {
  ...
  remove(@Param('id', ParseIntPipe) id: number): Promise<Attendance> {
