...
import { SeedersService as AuthSeedersService } from './auth/seeders/seeders.service';
...
async function runSeeds() {
  ...
  try {
    // Order matters: Auth first (permissions, roles, users), then dependent modules
    const authSeeder = app.get(AuthSeedersService);
